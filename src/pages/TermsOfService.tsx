        ...
        <div className="space-y-8">
          <Card>
            <CardHeader>
              ...
              <CardDescription>By using MindMatters, you agree to these terms</CardDescription>
            </CardHeader>
            <CardContent className="prose prose-slate max-w-none">
              <p>
                Welcome to MindMatters. By accessing or using our mental health platform, 
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>What MindMatters provides</CardDescription>
            </CardHeader>
            <CardContent className="prose prose-slate max-w-none">
              <p>MindMatters provides:</p>
              <ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-slate max-w-none">
              <p className="bg-yellow-50 p-4 rounded-lg border border-yellow-200">
                <strong>Important:</strong> MindMatters is not a substitute for professional 
          ...
          <Card>
            ...
            <CardContent className="prose prose-slate max-w-none">
              <p>
                To the fullest extent permitted by law, MindMatters shall not be liable for:
              </p>
              <ul>
          ...
          <Card>
            ...
            <CardContent className="prose prose-slate max-w-none">
              ...
              <p>
                For questions about these terms, contact us at legal@mindmatters.com
              </p>
